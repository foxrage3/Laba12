...
public class Laba12 {
    ...
    public static void singleThread() {
        ...
        System.out.println("First method time");
    ...
    public static void doubleThread() {
        ...
        System.out.println("Second method time");
        System.out.println(System.currentTimeMillis() - a);
    }
...
class MyThread extends Thread {
    ...
    public void run() {
        for (int i = 0; i < arr.length; i++) {
            arr[i] = (float) (arr[i] * Math.sin(0.2f + (i + shift) / 5) * Math.cos(0.2f + (i + shift) / 5) * Math.cos(0.4f + (i + shift) / 5));
        }
    }
}
